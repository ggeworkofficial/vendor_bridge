          ...
          >
            ...
            <div className="bg-accent rounded-lg p-4 text-sm text-accent-foreground">
              <p className="font-semibold mb-1">
                🛡️ VendorBridge Trust Guarantee
              </p>
              <p>
                This product is sourced and verified by our quality team. We
                handle all pricing, listing, and order fulfillment.
              </p>
            </div>
          </motion.div>
        </div>
              ...
              {reviewsMeta && reviewsMeta.total > reviewsMeta.limit && (
                <div className="flex justify-center pt-2">
                  <Button
                    ...
                    disabled={
                      reviewPage * reviewsMeta.limit >= reviewsMeta.total
                    }
                  >
                    Load More
                  </Button>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex gap-1">
                    {[1, 2, 3, 4, 5].map((rating) => (
                      ...
                      >
                        <Star
                          className={`h-6 w-6 ${rating <= newRating ? "fill-secondary text-secondary" : "text-muted-foreground"}`}
                        />
                      </button>
                    ))}
                  </div>
