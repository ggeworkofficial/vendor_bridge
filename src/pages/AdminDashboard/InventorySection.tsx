...
const PriorityBadge = ({ priority }: { priority: string }) => {
  ...
  return (
    <Badge className={`text-xs ${styles[priority] || ""}`}>{priority}</Badge>
  );
};
...
const InventorySection = () => {
  ...
  const setSelectedProduct = useInventoryStore(
  ...
  const handleSetPrimaryImage = async (imageId: string) => {
    ...
    try {
      ...
      toast({
        title: "Update failed",
        description: "Unable to set primary image.",
        variant: "destructive",
      });
    } finally {
    ...
    <div className="space-y-4">
          ...
          <TableBody>
            {inventory.map((product) => (
              <TableRow key={product.id}>
                ...
                <TableCell>
                  <PriorityBadge priority={product.quality_label} />
                </TableCell>
                <TableCell>
                  {product.verified ? (
                  ...
                  <div className="flex items-center justify-end gap-1">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setTimeout(() => handleViewReviews(), 100);
                      }}
                    >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <Input
                type="number"
                placeholder="0.00"
                value={createPrice === 0 ? "" : createPrice}
                onChange={(e) =>
                  setCreatePrice(
            ...
            <div className="space-y-1">
              ...
              <Input
                type="number"
                value={createQuantity === 0 ? "" : createQuantity}
                onChange={(e) => {
                  const val = e.target.value;
                  setCreateQuantity(val === "" ? 0 : Number(val));
                }}
                placeholder="1"
                min={1}
              />
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <Select
                        value={editQuality}
                        onValueChange={(value) => setEditQuality(value)}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    <div>
                      ...
                      <Select
                        value={editVerified.toString()}
                        onValueChange={(value) =>
                          setEditVerified(value === "true")
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
      ...
      >
        <AppDialogHeader
          ...
          subtitle="Are you sure you want to delete this inventory item?"
        />
        <AppDialogSection>
          <p className="text-sm text-muted-foreground">
      ...
      <BaseDialog
        open={isReviewsViewOpen}
        onOpenChange={(open) => {
          if (!open) {
            setIsReviewsViewOpen(false);
            setReviews([]);
          }
        }}
        maxWidth="3xl"
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className={`h-3 w-3 ${i < review.rating ? "fill-secondary text-secondary" : "text-muted-foreground"}`}
                        />
                      ))}
                    </div>
                  </div>
